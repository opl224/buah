							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Edit Pesanan</h2>
									</header>
									<?php
									$x=$data->row_array();
									?>
									<div class="panel-body">
										<form action="<?php echo base_url() ?>Pesanan/update_pesanan" method="post">
										<div class="form-horizontal form-bordered">
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="xnama" value="<?php echo $x['nama'] ?>" id="inputDefault" placeholder="Nama Pemesan">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="xbuah" value="<?php echo $x['buah'] ?>" id="inputDisabled" placeholder="Nama Buah">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="xjenis" value="<?php echo $x['jenis'] ?>" id="inputDisabled" placeholder="Jenis Buah">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="xjumlah" value="<?php echo $x['jumlah'] ?>" id="inputDisabled" placeholder="Jumlah Beli">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="xketerangan" value="<?php echo $x['keterangan'] ?>" id="inputDisabled" placeholder="Keterangan Buah">
												</div>
											</div>
