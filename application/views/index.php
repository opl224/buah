...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="<?= base_url('shop'); ?>">Shop New</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="<?= base_url('shop'); ?>">Fresh Fruit</a>
                    </div>
                </div>
                        ...
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <li><a href="<?= base_url('cart'); ?>" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                                </ul>
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2021 <a href="#">Toko Buah</a> Design By :
            <a href="https://html.design/">We</a></p>
    </div>
    <!-- End copyright  -->
