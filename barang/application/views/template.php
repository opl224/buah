...
<head>
    ...
    <title>Penjualan - Barang Serbaguna</title>
	<!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">RUANG ADMIN</a>
            </div>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>Website : <a href="" target="_blank">Penjualan-Codeigniter</a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
